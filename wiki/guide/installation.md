...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <properties>
        <cosky.version>5.7.1</cosky.version>
    </properties>
...
- [gradle.properties](https://github.com/Ahoo-Wang/CoSky/blob/main/gradle.properties) -- project version (`5.7.1`)
