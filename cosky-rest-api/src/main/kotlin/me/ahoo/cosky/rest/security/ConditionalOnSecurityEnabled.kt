 ...
 * @author ahoo wang
 */
@ConditionalOnProperty(value = [ConditionalOnSecurityEnabled.ENABLED_KEY], matchIfMissing = true)
annotation class ConditionalOnSecurityEnabled {
    companion object {
        const val ENABLED_KEY = SecurityProperties.PREFIX + EnabledSuffix.KEY
    }
}
