...
import { Config, ConfigHistory, ImportResponse } from "./types";
...
export class ConfigApiClient implements ApiMetadataCapable {
     ...
     */
    @get('/v1/namespaces/{namespace}/configs/export', { resultExtractor: ResultExtractors.Text })
    exportZip(@path('namespace') namespace: string, @request() httpRequest?: ParameterRequest, @attribute() attributes?: Record<string, any>): Promise<string> {
    ...
    getConfigs(@path('namespace') namespace: string, @request() httpRequest?: ParameterRequest, @attribute() attributes?: Record<string, any>): Promise<any> {
        throw autoGeneratedError(namespace, httpRequest, attributes);
    }
    ...
    getConfigVersions(@path('namespace') namespace: string, @path('configId') configId: string, @request() httpRequest?: ParameterRequest, @attribute() attributes?: Record<string, any>): Promise<any> {
        throw autoGeneratedError(namespace, configId, httpRequest, attributes);
    }
