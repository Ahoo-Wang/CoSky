...
import { SaveRoleRequest } from "./types";
...
export class RoleApiClient implements ApiMetadataCapable {
     ...
     */
    @get('/v1/roles')
    allRole(@request() httpRequest?: ParameterRequest, @attribute() attributes?: Record<string, any>): Promise<any> {
    ...
    getResourceBind(@path('roleName') roleName: string, @request() httpRequest?: ParameterRequest, @attribute() attributes?: Record<string, any>): Promise<any> {
