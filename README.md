...
> Download [cosky-rest-api-server](https://github.com/Ahoo-Wang/cosky/releases/download/1.3.2/cosky-rest-api-1.3.2.tar)

> tar *cosky-rest-api-1.3.2.tar*

```shell
cd cosky-rest-api-1.3.2
# Working directory: cosky-rest-api-1.3.2
