...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <properties>
        <cosky.version>1.3.18</cosky.version>
    </properties>
...
> Download [cosky-rest-api-server](https://github.com/Ahoo-Wang/cosky/releases/download/1.3.18/cosky-rest-api-1.3.18.tar)

> tar *cosky-rest-api-1.3.18.tar*

```shell
cd cosky-rest-api-1.3.18
# Working directory: cosky-rest-api-1.3.18
...
```shell
docker pull ahoowang/cosky-rest-api:1.3.18
docker run --name cosky-rest-api -d -p 8080:8080 --link redis -e COSKY_REDIS_URI=redis://redis:6379  ahoowang/cosky-rest-api:1.3.18
```
    ...
    spec:
      containers:
        - env:
          ...
          image: ahoowang/cosky-rest-api:1.3.18
          name: cosky-rest-api
          ports:
            - containerPort: 8080
              protocol: TCP
...
# or
java -jar cosky-config/build/libs/cosky-config-1.3.18-jmh.jar -bm thrpt -t 25 -wi 1 -rf json -f 1
```
...
# or
java -jar cosky-discovery/build/libs/cosky-discovery-1.3.18-jmh.jar -bm thrpt -t 25 -wi 1 -rf json -f 1
```
