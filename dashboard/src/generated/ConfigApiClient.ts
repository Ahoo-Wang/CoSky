...
export class ConfigApiClient implements ApiMetadataCapable {
     ...
     */
    @get('/v1/namespaces/{namespace}/configs/export', { resultExtractor: ResultExtractors.Bytes })
    exportZip(@path('namespace') namespace: string, @request() httpRequest?: ParameterRequest, @attribute() attributes?: Record<string, any>): Promise<Uint8Array<ArrayBuffer>> {
