...
> 下载 [rest-api-server](https://github.com/Ahoo-Wang/cosky/releases/download/1.2.9/cosky-rest-api-1.2.9.tar)

> 解压 *cosky-rest-api-1.2.9.tar*

```shell
cd cosky-rest-api-1.2.9
# 工作目录: cosky-rest-api-1.2.9
