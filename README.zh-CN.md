...
> 下载 [rest-api-server](https://github.com/Ahoo-Wang/cosky/releases/download/1.3.12/cosky-rest-api-1.3.12.tar)

> 解压 *cosky-rest-api-1.3.12.tar*

```shell
cd cosky-rest-api-1.3.12
# 工作目录: cosky-rest-api-1.3.12
