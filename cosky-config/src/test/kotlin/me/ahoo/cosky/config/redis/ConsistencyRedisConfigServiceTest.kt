 ...
 * @author ahoo wang
 */
internal class ConsistencyRedisConfigServiceTest : ConfigServiceSpec() {
    ...
    fun config() {
        ...
        val configService: ConfigService = ConsistencyRedisConfigService(delegate, listenerContainer)
    ...
    fun getConfigChanged() {
        ...
        val configService: ConfigService = ConsistencyRedisConfigService(
            delegate,
            listenerContainer
        ) { (namespacedConfigId) ->
